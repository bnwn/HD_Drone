...
#define DRONE_NAME MEIDUODUO

#if DRONE_NAME == MEIDUODUO
#define CONTROL_ANGLE_LOOP_ROLL_KP 400.0f// 150.0f
...
#define CONTROL_ANGLE_LOOP_PITCH_KP 400.0f //150.0f
...
#define CONTROL_RATE_LOOP_ROLL_KP 0.42f // 0.18f
#define CONTROL_RATE_LOOP_ROLL_KI 0.4f
#define OONTROL_RATE_LOOP_ROLL_INTEGRATOR_MAX 0.3f
#define CONTROL_RATE_LOOP_ROLL_KD 0.013f // 0.0095f
#define CONTROL_RATE_LOOP_PITCH_KP 0.42f // 0.18f
#define CONTROL_RATE_LOOP_PITCH_KI 0.4f
#define OONTROL_RATE_LOOP_PITCH_INTEGRATOR_MAX 0.3f
#define CONTROL_RATE_LOOP_PITCH_KD 0.013f // 0.0095f
#define CONTROL_RATE_LOOP_YAW_KP 0.6f
...
#define CONTROL_RATE_LOOP_ROLL_KI 0.0f //0.00013f
