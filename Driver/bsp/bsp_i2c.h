...
extern uint8_t I2C_PageWrite(uint8_t _salve_addr, uint32_t _addr, uint8_t *_buf);
extern uint32_t I2C_SequentialRead(uint8_t _slave_addr, uint32_t _addr, uint8 *_buf, uint32_t _size);
