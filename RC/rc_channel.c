...
//				pre_switch = data_buf[8];
		...
		if (rc_channels[4].rc_in) {
		
		}
		if (rc_channels[5].rc_in) {
		
		}
		if (rc_channels[6].rc_in) {
		
		}
		if (rc_channels[7].rc_in) {
		
		}
		if (rc_channels[8].rc_in) {
		
		}
		if (rc_channels[9].rc_in) {
		
		}
		if (rc_channels[10].rc_in) {
		
		}
		if (rc_channels[11].rc_in) {
